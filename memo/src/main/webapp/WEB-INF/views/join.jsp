...
<header class="top_nav">
 	<a href="/newmemo/memo_list"><i class="far fa-clipboard fa-fw"></i> MEMO LIST </a>
</header>
 
 <div class="join_section">
 	<form action="/newmemo/new_usr" method="post">
 		<label>ID</label> <input type="text" placeholder="ID" name="id" /> 
		<label>PW</label> <input type="password" placeholder="PASSWORD" name="pass" />
		<label>이름</label> <input type="text" placeholder="이름입력" name="name" /> 
		<label>생일</label> <select name="birthday_month">
